    ...
    <Box className="border-l border-t rounded-tl-[80px] rounded-br-[80px] bg-digiLightBlue">
      <div className="flex justify-center">
        <Box
          ...
          width={"60%"}
        >
          <Typography className=" text-red-500 font-bold text-center">
            {title}
          </Typography>
        </Box>
      </div>
      ...
      <Button className="bg-orange-gradient italic text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 p-2 m-4">
        Explore
      </Button>
    </Box>
  );
