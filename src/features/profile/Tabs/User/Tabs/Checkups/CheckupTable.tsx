        ...
        <Table>
          <TableHead>
            <TableRow className="font-bold">
              ...
              <TableCell className="font-bold text-center">Problem</TableCell>
              <TableCell className="font-bold text-center">Treatment</TableCell>
              <TableCell className="font-bold text-center">Doctor</TableCell>
            </TableRow>
          </TableHead>
          ...
          <TableBody>
            {events.map((event: any, index: number) => (
              <TableRow key={index}>
                ...
                <TableCell className="text-center">{event.subEvents}</TableCell>

                <TableCell className="text-center">{event.handledBy}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
